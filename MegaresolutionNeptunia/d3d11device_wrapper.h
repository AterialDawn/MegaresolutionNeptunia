...
//BORROWED FROM GeDoSaTo @ https://github.com/PeterTh/gedosato/blob/master/include/d3d11/d3d11dev.h ON 07/24/16 0d6b41b
...
public:
	ID3D11Device_Wrapper(ID3D11Device **ppID3D11Device, IDXGISwapChain_Wrapper* swapWrap);
